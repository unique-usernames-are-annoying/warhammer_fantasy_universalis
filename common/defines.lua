...
NCountry = {
	...
	ESTATE_PRIVILEGES_MAX_CONCURRENT = 6,		-- Max. number of privileges active at the same time. Also see ESTATE_MAX_PRIVILEGES in NAI ## WARHAMMER
	...
	TECH_AHEAD_OF_TIME = 0.15,		-- per year ahead. WARHAMMER - Normally 0.1
