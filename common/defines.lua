...
NDiplomacy = {
	...
	DESIRED_NUM_OF_ELECTORS = 11,
	MAX_FREE_CITIES = 6,
	MIN_NUM_ELECTORS_FOR_REMOVE_ELECTORATE = 2,		-- Limit is inclusive.
	HRE_PRINCE_AUTHORITY_THRESHOLD = 11,			-- Threshold below which you lose IA, and above which you gain it
	...
	HRE_HERETIC_PENALTY = 0.00,					-- Per heretic prince (halved by Peace of Westphalia)
	...
	PEACE_COST_DEMAND_PROVINCE = 0.9,					-- Demand a province (scales by province wealth, also used for annex) -- This was 0.8
	PEACE_COST_CONCEDE_PROVINCE = 0.9,				-- Demand colonial area province concession. --- This was 0.8
	PEACE_COST_BECOME_VASSAL = 0.9,					-- Vassalize a country (scales by province wealth)  --- This was 0.8
	PEACE_COST_PILLAGE_CAPITAL = 1,					-- Pillage a capital state's dev (scales by province wealth)
	PEACE_COST_RETURN_CORE = 0.9,						-- Return a core (scales by province wealth) --- This was 0.8
	PEACE_COST_REVOKE_CORE = 0.4,						-- Revoke a core (scales by province wealth)
	PEACE_COST_RELEASE_ANNEXED = 0.9,					-- Release annexed nation (scales by province wealth) --- This was 0.8
	...
	PEACE_COST_CONVERSION = 0.6,					-- scaled with countrysize for forced conversion in peace. --- This was 0.8
...
NCountry = {
	...
	ESTATE_PRIVILEGES_MAX_CONCURRENT = 7,		-- Max. number of privileges active at the same time. Also see ESTATE_MAX_PRIVILEGES in NAI ## WARHAMMER
	...
	TRIBE_MIGRATION_MIL_COST = 0,
	SIBERIAN_TRIBE_MIGRATION_BONUS = 0,
	SIBERIAN_TRIBE_MIGRATION_COOLDOWN_YEARS = 1,
	TRIBE_MIGRATION_NON_TRIBAL_LAND_COOLDOWN_YEARS = 1,
...
NMilitary = {
	...
	COSSACK_BASE_COST_MODIFIER = 1.0,				-- Cossack base cost is double as expensive
...
NAI = {
	...
	ESTATE_MAX_PRIVILEGES = 7, -- Also see ESTATE_PRIVILEGES_MAX_CONCURRENT in NCountry
